...
public class BluetoothLeService extends Service {
    private final static String TAG = "BLE APP";

    private BluetoothManager mBluetoothManager;
    public BluetoothAdapter mBluetoothAdapter;
    private BluetoothGattCharacteristic mLastCharacteristic = null;
...
*/
    ...
    public List<BluetoothGattService> getSupportedGattServices() {
        try {
            ...
            Log.i("BLE_APP", e.getMessage());
            return null;
        }
    }

    public BluetoothGattCharacteristic getLastCharactesticSent() {
        return mLastCharacteristic;
    }
